...
"
" unix: $HOME/.vim/syntax/truegrid.vim
"       $VIMRUNTIME/syntax/trugrid.vim
"
" windows: c:\vim\vimfiles\syntax\truegrid.vim, or
"          $VIMRUNTIME\syntax\truegrid.vim
"
...
" CHANGELOG
"
" 2004-xx-xx: Released 0.1.4
"
" 2004-03-05: Made some changes to the installation instructions which
...
syn keyword tgCon2DCSub lep lint lnof lo lod lp2 lpil lp ltp lar
...
syn region Normal matchgroup=tgComplex2 start="include" end="$"
...
let w:comment_index = 0
let w:comment='c '
let g:comment_time = localtime()
